...
<head>
    ...
    <title>Hitung KNN | <?php echo $title ?></title>
    <!-- Favicon-->
   ...
   <section class="content">
        <div class="container-fluid">
            ...
            <!-- #END# Hasil Perhitungan -->
                    <?php 
                        //insert data yang telah dihitung ke table data test
                        $SQL2 = $conn->prepare('INSERT INTO dtest(nama,sm1,sm2,sm3,sm4,sm5,sm6,bindo,bing,mat,komp,jurusan,hasil) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)');
                        $SQL2->bind_param('siiiiiiiiiiis',$nama2,$sm1,$sm2,$sm3,$sm4,$sm5,$sm6,$ind,$ing,$mtk,$kom,$jursmk,$juruniv2);
                        $SQL2->execute();
